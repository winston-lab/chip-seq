...
wildcard_constraints:
    ...
    annotation = "|".join(re.escape(x) for x in set(itertools.chain(*[FIGURES[figure]["annotations"].keys() for figure in FIGURES] + list(config["differential_occupancy"]["annotations"].keys())))),
    status = "all|passing",
